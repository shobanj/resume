...
\newcommand\cvaltcolor{oliveGreen}
...
\newcommand\cvtitle[2]{\color{darkGreen}{\Huge{\bf{#1}}} \Huge{#2}}
\newcommand\cvcontact[3] {
  \small {
    \href{mailto:#1}{\faAt \quad #1} \\
    \href{tel:#2}{\faPhone \quad #2} \\
    {\href{https://www.linkedin.com/in/#3/}{\faLinkedin \quad www.linkedin.com/in/#3/}}
  }
}
...
\begin{minipage}[b]{.3\linewidth}
  \cvcontact{shoban@gmail.com}{+91-98401-46057}{shobanj}
\end{minipage}
...
\begin{wraptable}{R}{6cm}
  ...
  \begin{tabular}{l|p{4cm}}
    \hline
    \cvte{2025}{\textbf{Patent Granted} -
      \href{https://patents.justia.com/patent/12236185}{Adding
        annotations from a printed version of a document to a digital
    ...
    \cvte{2022}{Developed R / Python based  Knowledge Management Capability assessment and analysis tool - recognized as a Six Sigma project} \\
    ...
    \cvte{2010}{PoC on production printer simulator - Qt/C++ which kickstarted a new project} \\
...
With around thirty two years of experience in the IT industry in
architecting and managing multiple projects and functions in domains
like printing, semiconductor, telecom, automation, industrial, and
workflow.

\section*{Professional Experience}
  
\cvsubsection{HCL Technologies, Chennai}{Dec 2002}{Sep 2026}

Extensively managed programs and technically contributed to the Office
Automation (Office \& Production Devices), Semiconductor (ATEs, Ball
bonders) and Industrial (Frequency Convertors) domains. GenAI
Blackbelt.

\cvprojectentry{Semiconductor Equipment Practice}{Semiconductors}{Nov 2024}{Till date}

Part of Semiconductor Equipment Practice group, responsible for
bridging and building new solutions, service lines, proposals for the
various semi engagements within the organization.

Working on GenAI based domain specific solutions on the ATE, wafer
inspection and metrology process spaces for Semiconductor Equipment
manufacturers.

Supporting the team in creating a GenAI based ATE Code Generator
platform that enables the test engineer to generate ATE OEM specific
device test code. Developed a GenAI based test optimizer to help detect and
reduce the PLM software based test cases of a wafer inspection and
metrology OEM by 13\% and improved productivity by a factor of 6.

Working on advanced chunking of semi knowedge sources for RAG
ingestion, knowledge graphs, Agentic RCA anayis for predictive
analytics, declarative 3D model generation of semi parts + part
classification based on images / prompts.

\cvprojectentry{Software Development Support}{Semiconductors}{Jan 2024}{Oct 2024}

Managed a group of over 110 members placed at multiple locations
covering QA and SW development for multiple divisions spanning tools
on Metrology and Wafer inspection using eBeam technology,
Semiconductor Control Systems, Data Engineering, IT R\&D with teams
from India (Chennai, Bengaluru, Mumbai, Pune), US and Canada. Have
been responsible for handling the operational aspects of running the
...
covering development, sustenance and enhancement of printer
drivers,content management system, logs acquisition \& analysis,
\textbf{LIDAR based AI model training and inference, AR / VR solution}
that usedobject and state detection, enterprise / cloud based print
solutions,enhancements of a public print kiosk, a playstore equivalent
forprinters and associated QA activities.
...
from 32 bit to 64 bit to overcome the 4GB RAM limit.
...
geographical locations and time zones. I was responsible for
...
different levels of senior management on the progress and challenges. We
had completed the program successfully 2 weeks ahead of schedule. This
was recognized and \textbf{awarded as the best project executed at this
...
the efficiency of the QA department (man power, cost, time
...
The program consisted of multiple teams / projects with a team size varying from 8 to 18 members working off India and Japan. I was responsible for
...
I was responsible for a team of 7 members, managing the projects and
...
My responsibility was to manage the team of 11 - 8 members, maintain
...
I was responsible for managing a team of 2 engineers to implement the
plotting capability. We were responsible for designing, coding, testing
...
I was responsible for managing the specified programs with the team
...
My responsibility within the team was to plan, schedule and manage the
team of 4 for development and sustenance of auto-tests. In addition
to management, I was also responsible for process compliance and
...
This project refactored the wire bonder tool by decoupling the domain
...
A new feature for the wire bonder suite of tools was requested to
...
I was responsible for architecting the host part of the
...
I was responsible for the architecture and management of the EzTest
...
I was responsible for the design and managed a team of three to
...
I was responsible for bringing back two projects to be developed
...
I was also responsible for managing a team of 7 for a feature point
...
display renderer capable of rendering complex documents with support
...
\begin{itemize}
  \item{\bf{HCL Technologies}}
    ...
    \item Published papers on \textbf{`Big data analytics'},
    ...
    \item Took up various additional roles
      ...
      \item \textbf{Patent Reviewer} to streamline and be the first
        line of reviewing the patent applications by the team and
...
\item
  \textbf{Patents Granted} -
  \begin{itemize}
  \item \href{https://patents.justia.com/patent/12086483}{Using LIDAR To
    Define Printable Area For Document Printing.}
  \item \href{https://patents.justia.com/patent/12236185}{Methods
    and systems for adding annotations from a printed version of a
    document to a digital version of the document}
  \end{itemize}
\item \textbf{Patents Published} -
  \begin{itemize}
  \item \href{https://patents.justia.com/patent/20260143079}{Methods
    And Systems For Capturing Multiple Pages At A Mobile Device}
  \item \href{https://patents.justia.com/patent/20260143073}{Methods
    And Systems For Scanning Multiple Pages At A Multi-Function
    Device}
  \item \href{https://patents.justia.com/patent/20250244933}{Methods
    And Systems For Printing A Document Using A Machine-Readable Code}
  \item \href{https://patents.google.com/patent/US20190294385A1}{Method and
    system for arranging and printing pages according to search
    criteria}
  \end{itemize}

\item Published book titled \textbf{GenAI Demystified: No Ph.D
  Required!}, 2026 - \href{https://www.amazon.in/dp/B0GVPPDSQ5}{ISBN
  979-8903924516} \& \textbf{The AI Survival Guide: How to Befriend
  Your Future Robot Overlords}, 2025 -
  \href{https://www.amazon.in/dp/9334254882}{ISBN 9789334254884}
  worldwide.
...
\section*{External Lectures}

\begin{itemize}
    \item 2026: One credit lecture on Statistical Analytics using R for Biomedical engg. students at SSN College of Engg.
\end{itemize}
...
\item \href{https://www.coursera.org/account/accomplishments/verify/O1JNCHQ9U3FQ}{Leading with Digital Strategy (IIM Ahmedabad, 2026)}

\item \href{https://www.coursera.org/account/accomplishments/specialization/1RZ5C1R71A3C}{Semiconductor Packaging Specialization (Arizona State University, 2026)}
...
\cveducation{B.E.}{Computer Science}{Bharathiar University}{74.77\%}
...
\centering{
  ...
  \href{https://github.com/shobanj}{\faGithub} App Development |
