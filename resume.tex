...
With over thirty years of experience in the IT industry
...
test code. Developed a GenAI based test optimizer to help detect and
...
Working on a data ingesion engine to use as a RAG source to ingest
customer data using Apache Prefect employing advanced chunking and
retrieval for use by GenAI applications.
